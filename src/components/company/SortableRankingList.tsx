  ...
  return (
    ...
    >
      ...
      {showCount && count !== undefined && (
        <div className="flex items-center justify-center min-w-[2.5rem] h-6 bg-gray-100 dark:bg-gray-700 rounded-full text-xs font-medium text-gray-600 dark:text-gray-300">
          {count}
        </div>
      )}
    </div>
